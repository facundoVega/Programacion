...
public static function TraerTodosLosProductosBd(){
		...
		$qry = $obj->RetornarConsulta("SELECT codigo_barra AS codBarra , nombre AS nombre , path_foto AS pathFoto FROM producto");
		$qry->execute();
		return $qry->FetchAll(PDO::FETCH_CLASS,"Producto");
		//var_dump($qry);
